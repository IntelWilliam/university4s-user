    ...
    return (
      <div className="container gray-font" style={{marginTop: '2em', 'marginBottom': '3em'}}>
        <div className="col-xs-12 ">
          ...
          <p className="text-condition">El acceso y uso de este sitio web se rige por los "Términos y condiciones" descritos a
            continuación, así como por la legislación que se aplique en la República de Perú.
            En consecuencia, todas las visitas y todos los contratos y transacciones que se realicen
            en este sitio, como asimismo sus efectos jurídicos, quedarán regidos por estas reglas y
            sometidas a esta legislación.
          </p>

          {/*<h1> Oficina de Atención al Cliente</h1>*/}
          <p className="text-condition">Los Términos y condiciones contenidos en este instrumento se aplicarán y se entenderá que
            ...
            de este sitio e International Bilingual Company S.A.C, la cual se denominará en adelante también en forma
          ...
          <p className="text-condition">Es requisito para el uso de la página Web de International Bilingual Company S.A.C la aceptación de los
          ...
          <p className="text-condition">International Bilingual Company S.A.C se reserva el derecho de actualizar y/o modificar los Términos y
          ...
          <p className="text-condition">Realizaremos nuestros mejores esfuerzos para asegurar la disponibilidad, sin interrupciones,
            de los servicios de la presente página web, así como en la ausencia de errores en cualquier
            transmisión de información que pudiera tener lugar. No obstante, y debido a la naturaleza
            misma de internet, no es posible garantizar tales extremos. </p>

          <p className="text-condition">Asimismo, el acceso a los servicios de la presente página web podría ocasionalmente verse
            suspendido o restringido a efectos de la realización de trabajos de reparación o
            mantenimiento, o la introducción de nuevos productos o servicios. Procuraremos limitar
            la frecuencia y duración de tales suspensiones o restricciones.</p>

          <p>A continuación detallamos los Términos y condiciones:</p>
          ...
          <ol>
            ...
            <p className="text-condition">Para usar la web es necesario adquirir el producto. El registro de cada usuario se
            ...
            <p className="text-condition">Los usuarios que se registren no tendrán que ingresar sus datos por cada compra posterior
            ...
            <p className="text-condition">El usuario dispondrá, una vez registrado, de un nombre y contraseña o clave definitiva
              que le permitirá el acceso personalizado, confidencial y seguro. El usuario tendrá la
              posibilidad de cambiar la clave de acceso, para lo cual deberá sujetarse al
            ...
            <p className="text-condition">El usuario gozará de todos los derechos que le reconoce la legislación sobre protección
