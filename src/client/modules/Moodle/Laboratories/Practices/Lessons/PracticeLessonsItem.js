...
class LessonItem extends React.Component {
    ...
    render() {
        ...
        let href = Constants.ADMIN_PATH + `/user-area/practices/lessons/Lesson/?levelName=${this.props.levelName}&subLevelName=${this.props.subLevelName}&subLevelId=${this.props.subId}&lessonName=${this.props.lessonName}&lessonId=${this.props.lessonId}&lessonIndex=${this.props.lessonIndex}`
