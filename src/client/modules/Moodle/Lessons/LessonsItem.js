...
class LessonItem extends React.Component {
    ...
    render() {
        ...
        let isLast = "false"
        if(this.props.lessonIndex == this.props.lastLesson)
            isLast = "true"
        let href = Constants.ADMIN_PATH + `/user-area/course/lessons/lesson/?levelName=${this.props.levelName}&subName=${this.props.subLevelName}&subId=${this.props.subId}&lessonId=${this.props.lessonId}&lastLesson=${isLast}&lessonName=${this.props.lessonName}&lessonIndex=${this.props.lessonIndex}`
