...
class EntryItem extends React.Component {
  ...
  goEntry() {
    switch (this.props.entry.entryType) {
      case 0:
      {const hrefPractice = '/user-area/practices/lessons/exercise/?levelName=' + this.props.entry.nameLevel + '&subLevelName=' + this.props.entry.nameSubLevel + '&subLevelId=' + this.props.entry.sublevelMoodleId + '&lessonName=' + this.props.entry.nameLesson + '&lessonId=' + this.props.entry.lessonMoodleId + '&lessonType=' + this.props.entry.labPracticeType + '&lessonIndex=1';
      ...
      break;
      case 9:
      this.playVideo('/api/videos/' + this.props.entry.uriFile, this.props.entry.name)
      break;
      case 1:
      ...
      break;
      case 4:
      this.playAudioText(this.props.entry.uriFile, this.props.entry.name, this.props.entry.text)
      // this.newTab(this.props.entry.uriFile)
      break;
      case 3:
      ...
      case 5:{
        ...
        this.context.router.push({pathname: viewPDF,  query: {name: this.props.entry.name, ultTo: this.props.entry.uriFile, lessonId: this.props.location.lessonId, subName: this.props.location.subName, lessonIndex: this.props.location.lessonIndex}});
        break;}
        case 6:{
          // console.log('this.props.entry', this.props.entry);
          const hrefWebPractica = '/user-area/practice-web/level/' + this.props.entry.levelWebLevelId + '/sub-level/' + this.props.entry.subWebSublevelId + '/lesson/' + this.props.entry.lessonWebLessonId   + '/levelName/' + this.props.entry.nameSubLevel;
      ...
      render() {
        ...
        return (
          <div className="col-xs-12">
            <div className="col-xs-12 course-content mousePoint" onClick={this.goEntry.bind(this)}>
            ...
            <div id="myModal2" className="videoModal">
              <span className="closeModal" onClick={this.closeModal2.bind(this)}>&times;</span>
            ...
            <div className="col-xs-8 col-xs-offset-2 margin-audio-text" style={{color: "white"}}>
