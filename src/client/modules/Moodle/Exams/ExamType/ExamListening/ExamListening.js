...
export default class ExamListening extends React.Component {
  ...
  checkExcercises() {
    ...
    for (let index in this.refs) {
      if (index != "audioPlayer") this.refs[index].checkAnswer();
    }
  ...
  render() {
    ...
    let urlAudio =
      ...
      this.props.location.query.exam_id +
      `.mp3`;
    let playClass = !this.state.isPlay
      ? "play-images mousePoint"
      : "play-images mousePoint play-images-active";
    let muteClass = this.state.muted
      ? "play-images mousePoint"
      : "play-images mousePoint play-images-active";
                      ...
                      <div className="row">
                        ...
                        <div className="col-xs-12">
                          <p className="info-description">
                            ...
                            alternativas de las cuales podrá elegir solo una
                            como respuesta.{" "}
                          </p>
                          <p className="info-description">
            ...
            <div className="col-xs-12">
              ...
              <div className="row">
                <div className="col-xs-12 play-container">
                  <img
                    className={playClass}
                    src="/images/Comprensión-auditiva_0000_PLAY.png"
                    onClick={this.playAudio.bind(this)}
                  />
                  <img
                    className={muteClass}
                    src="/images/Comprensión-auditiva_0001_VOLUMEN.png"
