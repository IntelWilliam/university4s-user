                  ...
                  <div className="info-title-container">
                    <div className="row">
                      ...
                      <div className="col-xs-12">
                        ...
                        <p className="info-description">El tiempo de duración del examen es de <span className="info-description bold">30 minutos </span>, una vez concluido el tiempo se calificará automaticamente. </p>
                      </div>
                    </div>
                  </div>
                </div>
