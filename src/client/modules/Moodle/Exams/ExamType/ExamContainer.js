                      ...
                      <div className="words-to-translate">
                        <div className="row">
                          ...
                          {arr.map((answer, index) => {
                            ...
                            let style = {};
                            if (this.state.correct === false && this.state.selected == index) {
                              style = styleWrong
                            } else if (this.state.correct === false && this.props.item.answer_index == index + 1) {
                              style = styleSelec
                            ...
                            //     style = styleWrong
                            return (
                              <span key={index} className="mark-word mousePoint" style={style}
                                    onClick={this.userAnswer.bind(this, index)}>{answer}</span>
                            )
                          })}
                        </div>
                      </div>
