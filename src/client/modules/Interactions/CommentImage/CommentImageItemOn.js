...
class CommentImageItemOn extends React.Component {
  ...
  speakWord() {
    this.props.triggerListenChange.call(
      null,
      this.props.name,
      this.props.refComponent
    );
  ...
  sayWordSpeed() {
    // se pronuncia la palabra deseada
    Pronouncer.sayWord(this.props.name.replace(/_/g, ' .'), null, {
      rate: 0.5,
    });
  }
            ...
            if (this.props.classCorrect == ' correct-pronunciation') {
              ...
              if (this.props.listening) {
                return (
                  <div className='enter-comment'>
                    <div
                      className='icon-comment-container'
                      onClick={this.sayWord.bind(this)}
                    >
                      <img
                    ...
                    <div
                      className='icon-comment-container'
                      onClick={this.sayWordSpeed.bind(this)}
                    >
                      <img
                    ...
                    <div
                      className='icon-comment-container micro-active'
                      onClick={this.speakWord.bind(this)}
                    >
                      <img
                        src='/images/microactive.png'
                        className='icon-comment mousePoint'
                      />
                    </div>
                  </div>
              ...
              <div className='margin-top-container text-to-say-container'>
                <div className='row image-drag'>
                  <div className='col-xs-12 text-to-say-container'>
                    ...
                    <span className='text-to-say'>
                      /&nbsp;{sentenceCase(this.props.translation)}
                    </span>
                  </div>
                  {(() => {
                    if (this.props.castell) {
                      return (
                        <div className='col-xs-12 text-to-say-container'>
                          <span className='text-to-say blue-text'>
                  ...
                  <div className='col-xs-12 text-to-say-container'>
                    <span className='whatAmISaying'>
                      {sentenceCase(this.props.whatAmISaying)}
                    </span>
                  </div>
                </div>
              </div>
