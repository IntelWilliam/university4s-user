...
export default class Dustbin extends Component {
  ...
  render() {
    const { image, isOver, canDrop, connectDropTarget, lastDroppedItem } = this.props;
      ...
      <div className="image-drag-excercise col-xs-9">
                <div className="comment-item col-xs-4">
                    <div className="image-container-drag">
                        <img className="image-drag" src={image} />
                    </div>
                </div>
                          ...
                          return (
                            <div className="row">
                                <div className="col-xs-12">
                                    <div style={{textAlign: 'end'}}> <span className="text-to-say">{sentenceCase(lastDroppedItem.name)}/</span> <span>{sentenceCase(lastDroppedItem.translation)}</span></div>
                                </div>
                                <div className="col-xs-12">
