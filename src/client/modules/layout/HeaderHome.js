                            ...
                            <div className="row height-100">
                                ...
                                <div className="col-xs height-100 menu-top-container">
                                    <ul className="menu-top menu-top-flex" >
                                        <Link to={videoTutorial}  className="item-menu mousePoint tutorial-button">
                                            <span>Video tutoriales</span>
                                        </Link>
                                        <Link to={'/?goTo=Nosotros'}  className="item-menu mousePoint">
                                            <span onClick={this.goTo.bind(this, "#Nosotros")}>Nosotros</span>
                                        </Link>
                                        <Link to={'/?goTo=Programas'} className="item-menu-border mousePoint">
                                          <span onClick={this.goTo.bind(this, "#Programas")}>Programas</span>
                                        </Link>
                                        <Link to={'/?goTo=Testimonios'} className="item-menu-border mousePoint">
                                          <span onClick={this.goTo.bind(this, "#Testimonios")}>Testimonios</span>
                                        </Link>
                                        <Link to={'/?goTo=Convenios'} className="item-menu-border mousePoint">
                                          <span onClick={this.goTo.bind(this, "#Convenios")}>Convenios</span>
                                        </Link>
                                        <Link to={'/?goTo=Contacto'} className="item-menu-border mousePoint">
                                          <span onClick={this.goTo.bind(this, "#Contacto")}>Contacto</span>
                                        </Link>
                                        <li onClick={this.goNewPlatform.bind(this, 'new')} className="item-menu mousePoint tutorial-button old-platform-link"
                                            style={{maxWidth: '8em', marginRight: '1em'}}>
                                            <span>Plataforma nueva versión
                                            </span>
                                        </li>
                                        <li onClick={this.goNewPlatform.bind(this, 'old')} className="item-menu mousePoint tutorial-button old-platform-link"
                                            style={{maxWidth: '8em', maxHeight: '80%'}}>
                ...
                <div className={openMenuClass}>
                    <div className="col-xs-12">
                        ...
                        <div className="col-xs-12 item-mobile-menu">
                          <a className="link-menu" onClick={this.goTo.bind(this, "#Nosotros")}>Nosotros</a>
                        </div>
                        <div className="col-xs-12 item-mobile-menu">
                          <a className="link-menu" onClick={this.goTo.bind(this, "#Programas")}>Programas</a>
                        </div>
                        <div className="col-xs-12 item-mobile-menu">
                          <a className="link-menu" onClick={this.goTo.bind(this, "#Testimonios")}>Testimonios</a>
                        </div>
                        <div className="col-xs-12 item-mobile-menu">
                          <a className="link-menu" onClick={this.goTo.bind(this, "#Convenios")}>Convenios</a>
                        </div>
                        <div className="col-xs-12 item-mobile-menu">
                          <a className="link-menu" onClick={this.goTo.bind(this, "#Contacto")}>Contacto</a>
                        </div>
