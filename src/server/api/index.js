...
router.use('/examaudio', express.static(path.join("/var", "www", "html", "dev.akronenglish1.com", "public", "uploads", 'exams')))
router.use('/simulationaudio', express.static(path.join("/var", "www", "html", "dev.akronenglish1.com", "public", "uploads", 'simulators')))
