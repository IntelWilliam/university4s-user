...
router.post('/login', (req, res) => {
  request({
    uri: Constants.API_BASE_URL_CHAT + 'login',
    method: "POST",
    form: {
...
router.post('/session', (req, res) => {
  ...
  if (!req.body.roomId && req.body.studentId && req.body.time && req.body.score) {
  ...
  addPercepAttention(req.body, (err, response)=>{
    ...
    request({
      uri: Constants.API_BASE_URL_CHAT + 'session',
      method: "POST",
      form: {
        teacherId: teacherId,
...
router.post('/session/homework', (req, res) => {
  ...
  request({
    uri: Constants.API_BASE_URL_CHAT + 'homework',
    method: "POST",
    form: {
