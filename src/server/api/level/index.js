...
import { getLevel, addLevel, updateLevel, removeLevel } from 'src/server/lib/level'
...
router.put('/:id', (req, res) => {
  ...
  updateLevel(id, params, (err, level) => {
    if (err) return res.status(500).json(err)
    res.json(level)
  })
})
